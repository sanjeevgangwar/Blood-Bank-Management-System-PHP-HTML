			...
			<div class="container-fluid">
				...
				<form class="navbar-form navbar-left">
					<div class="input-group">
						<input type="text" value="" class="form-control" style="border-radius: 20px 0 0 20px;"placeholder="Search dashboard...">
						<span class="input-group-btn"><button type="button" class="btn btn-primary;"style="background-color:rgb(29 51 62 / 92%);color:white;font-size:15px;border-radius: 0 20px 20px 0;">Go</button></span>
					</div>
				</form>
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="../assets/img/admin sanju.jpg" class="img-circle" alt="Avatar"> <span><?php echo $_SESSION['username'];?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>

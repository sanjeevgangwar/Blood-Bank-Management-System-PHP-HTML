...
<body>
			...
			<div class="container-fluid">
				...
				<form class="navbar-form navbar-left">
					<div class="input-group">
						<input type="text" value="" style="border-radius: 20px 0 0 20px;"class="form-control" placeholder="Search dashboard...">
						<span class="input-group-btn"><button type="button"  style="border-radius: 0 20px 20px 0;background: rgb(29 51 62 / 92%); border:none; font-size:15px;"class="btn btn-primary">Go</button></span>
					</div>
				</form>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <button type="button" class="btn btn-default" style="background: rgba(29, 51, 62, 0.92);border-radius: 20px;border: none;color: white;"data-dismiss="modal">Close</button>
         <a href="../logout.php"> <button type="button" class="btn btn-danger" style="background: rgba(29, 51, 62, 0.92);border-radius: 20px;border: none;color: white;">Logout</button></a>
        </div>
      </div>
    </div>
  </div>

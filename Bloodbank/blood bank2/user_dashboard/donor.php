...
<div class="main">
  ...
  <h2 style="color:rgb(0, 82, 123)">Hello,<span style="color: rgb(0, 4, 6);"> <?php echo $_SESSION['membername']?></span> Listed Donor. </h2> <br />
  <p><button type="button" style="background:rgb(29 51 62 / 92%);border:none; border-radius:18px;font-size:18px;" class="btn btn-primary" data-toggle="modal" data-target="#adddonor">Donate Blood</button></p> <br />           
  
   <h2 style="color:rgb(0, 82, 123)"> Recent Donors</h2> <br />

   

  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home" style="color:rgb(0, 82, 123)" >All Groups</a></li>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <h3 style="color:rgb(0, 82, 123)">All Donors</h3>
      <p><?php 

...
<div class="main">
  ...
  <h2 style="color:rgb(0, 82, 123)">Hello,  <span style="color:rgb(0, 4, 6);"> <?php echo $_SESSION['membername']?></span> Listed Requester. </h2> <br />
  <p><button type="button" style="background:rgb(29 51 62 / 92%);border:none; border-radius:18px; font-size:15px"class="btn btn-primary" data-toggle="modal" data-target="#needblood">Request For Blood</button></p> <br />           

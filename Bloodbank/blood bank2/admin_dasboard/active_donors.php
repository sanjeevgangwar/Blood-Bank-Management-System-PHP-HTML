      ...
      while($row = $members->fetch_array()) {
       ?>
        ...
        <?php  } ?></td>
      		...
      		<button type="button" style="background:rgb(0, 4, 6);border:none; border-radius:20px;" data-toggle="modal" data-target="#editdonor<?php echo $row['donor_id'];?>" class="btn btn-warning">Edit</button></td>
      	</tr>
      	 <!-- delete city modal -->

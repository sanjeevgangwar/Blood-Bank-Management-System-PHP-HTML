...
<div class="main">
  ...
  <h2 style="color:rgb(0, 82, 123)">Hello,  <span style="color:rgb(0, 4, 6);" > <?php echo $_SESSION['username']?></span> Manage City Here. </h2> <br />
  <p><button type="button"style="background:rgb(29 51 62 / 92%);border:none; border-radius:20px;"class="btn btn-primary" data-toggle="modal" data-target="#addcity">Add new</button></p> <br />           
       ...
       ?>
        ...
        <td><?php echo $row['city_name'];?></td>
      	<td><?php echo $row['state_name'];?></td>
      		...
      		<td><button type="button" style="background:rgb(29 51 62 / 92%);;border:none; border-radius:20px;"data-toggle="modal" data-target="#deletecity<?php echo $row['city_id']?>" class="btn btn-danger">Delete</button>
      		<button type="button" style="background:rgb(0, 4, 6);;border:none; border-radius:20px;" data-toggle="modal" data-target="#editcity<?php echo $row['city_id'];?>" class="btn btn-warning">Edit</button></td>
      	</tr>
      	 <!-- delete city modal -->

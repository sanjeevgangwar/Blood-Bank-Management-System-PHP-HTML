...
<div class="main">
  ...
  <h2 style="color:rgb(0, 82, 123)">Hello,  <span style="color:rgb(0, 4, 6);"> <?php echo $_SESSION['username']?></span> Manage State Here. </h2> <br />
  <p><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addstate" style="background:rgb(29 51 62 / 92%);border:none; border-radius:20px;" >Add new</button></p>    <br />         
    ...
    <tbody>
      ...
      while($row = $select->fetch_array()){ ?>
      	...
      	<tr>
      		...
      		<td><button type="button" style="background:rgb(29 51 62 / 92%);border:none; border-radius:20px;" data-toggle="modal" data-target="#deletestate<?php echo $row['state_id']?>" class="btn btn-danger">Delete</button>
      		<button type="button" style="background:rgb(0, 4, 6);border:none; border-radius:20px;" data-toggle="modal" data-target="#editstate<?php echo $row['state_id'];?>" class="btn btn-warning">Edit</button></td>
      	</tr>
      	<!-- delete state modal  -->

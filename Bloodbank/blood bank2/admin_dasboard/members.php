...
<div class="main">
  ...
  <h2 style="color:rgb(0, 82, 123)">Hello,  <span style="color:rgb(0, 4, 6);"> <?php echo $_SESSION['username']?></span> Manage Members Here. </h2> <br />
  <p><button type="button" style="background:rgb(29 51 62 / 92%);border:none; border-radius:20px;" class="btn btn-primary" data-toggle="modal" data-target="#addmember">Add new</button></p> <br />           
      ...
      while($row = $members->fetch_array()) {
       ?>
        ...
        <?php  } ?></td>
      		...
      		<td><button type="button" style="background:rgb(29 51 62 / 92%);border:none; border-radius:20px;" data-toggle="modal" data-target="#deletemember<?php echo $row['member_id']?>" class="btn btn-danger">Delete</button>
      		<button type="button"style="background:rgb(0, 4, 6);border:none; border-radius:20px;" data-toggle="modal" data-target="#editmember<?php echo $row['member_id'];?>" class="btn btn-warning">Edit</button></td>
      	</tr>
      	 <!-- delete city modal -->
